---
name: roaster-project
description: Project control skill for pi-roaster migration, runtime hardening, and delivery readiness.
version: 1.0.0
stability: stable
tier: project
...
budget:
  max_tool_calls: 110
  max_tokens: 220000
outputs: [scope_alignment, workstream_decision, migration_plan, verification_matrix, delivery_report]
...
# Roaster Project Skill

## Objective
Turn migration and hardening work in `pi-roaster` into an executable, verifiable, and reversible delivery flow while preserving upstream compatibility.

## Trigger
Use this skill when requests involve:
- migration from `oh-my-opencode` into `pi-roaster`
...
- Preserve compatibility path with upstream `pi-mono`.
...
## Resource Navigation
- Priority matrix and phased strategy: `skills/project/roaster-project/references/migration-priority-matrix.md`
- Package boundaries and invariants: `skills/project/roaster-project/references/package-boundaries.md`
- Skill DoD quick-check script: `skills/project/roaster-project/scripts/check-skill-dod.sh`
