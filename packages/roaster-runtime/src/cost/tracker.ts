import type { RoasterConfig, SessionCostSummary, SessionCostTotals } from "../types.js";
...
export class SessionCostTracker {
  private readonly config: RoasterConfig["infrastructure"]["costTracking"];
  private readonly sessions = new Map<string, SessionCostState>();

  constructor(config: RoasterConfig["infrastructure"]["costTracking"]) {
    this.config = config;
  }
